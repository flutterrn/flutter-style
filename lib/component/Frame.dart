...
import 'package:rnlikestyles/Tool/base.dart' as base;
...
class Frame extends StatelessWidget {
  ...
  StylesObj mStyles = const StylesObj();
  Frame(
      {Key? key,
      this.children = const [],
      this.styles,
  ...
  renderContainer(Widget child, [StylesObj? styles]) {
    StylesObj newStyles = styles ?? mStyles;
