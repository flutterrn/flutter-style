...
// 获取wrap主轴方向
WrapCrossAlignment? getWrapJustifyContent(StylesObj styles) {
...
// 获取主轴方向
MainAxisAlignment getJustifyContent(StylesObj styles) {
  if (styles.justifyContent != null) {
    switch (styles.justifyContent) {
      case 'flex-start':
...
// 获取次轴方向
CrossAxisAlignment getAlignItems(StylesObj styles) {
...
// 获取次轴方向
WrapAlignment? getWrapAlignItems(StylesObj styles) {
  if (styles.alignItems != null) {
    switch (styles.alignItems) {
      case 'flex-start':
...
// 获取flex布局方向
getFlexDirection(StylesObj styles) {
...
// 判断当前方向
getRowDirection(StylesObj styles) {
  if (styles.flexDirection.isNotEmpty) {
...
// 判断是否是百分比布局
getPercentageState(StylesObj styles) {
...
// 获取容器最大最小宽度
getContaionMaxMin(StylesObj styles) {
...
// 获取边框宽度
double getBorderWidth(StylesObj styles) {
...
// 获取高度
double getHeight(StylesObj styles) {
...
// 获取padding
EdgeInsets getPadding(StylesObj styles) {
  double defValue = 0.0;
...
// 获取margin
EdgeInsets getMargin(StylesObj styles) {
  double defValue = 0.0;
...
// 获取左侧边框
BorderSide getLeftBorder(StylesObj styles) {
...
// 获取顶部边框
BorderSide getTopBorder(StylesObj styles) {
...
// 获取右侧边框
BorderSide getRightBorder(StylesObj styles) {
...
// 获取底部边框
BorderSide getBottomBorder(StylesObj styles) {
...
// 获取边框
BoxBorder getBorder(StylesObj styles) {
  if (styles.borderWidth != null &&
...
// 获取边框圆角
BorderRadius getBorderRadius(StylesObj styles) {
...
// 获取背景颜色
getBackgroundColor(StylesObj styles) {
...
// 百分比宽高
getPercentage({Widget? childView, StylesObj? styles}) {
  double? mWidth;
  double? mHeight;
  if (getTypeOf(styles?.width) == '%') {
...
// 设置边框
Decoration getDecoration(StylesObj styles) {
...
// 获取渐变色
Gradient? getGradient(StylesObj styles) {
...
// 获取阴影
getListBoxShadow(StylesObj styles) {
...
// 获取字符串阴影
getLisStrigBoxShadow(StylesObj styles) {
